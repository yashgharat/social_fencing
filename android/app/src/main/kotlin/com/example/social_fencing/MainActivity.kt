package com.example.social_fencing
...
class MainActivity: FlutterActivity() {
    ptivate val CHANNEL = "com.stl.radar"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Radar.initialize("prj_test_pk_0ed54c4da99aa6deeacea97dd9eb025098483ff1")

        // todo in steps 3 and 4
    }

    Radar.trackOnce { status, location, events, user ->
    user?.geofences?.forEach { 
        geofence ->
        if (geofence.tag == "Manthi") {
